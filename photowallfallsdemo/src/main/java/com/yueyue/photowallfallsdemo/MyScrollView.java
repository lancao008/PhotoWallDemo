...
/**
 * author : yueyue on 2018/3/30 11:15
 * desc   : 自定义的ScrollView，在其中动态地对图片进行添加。
 */
...
public class MyScrollView extends ScrollView implements View.OnTouchListener {
    ...
    class LoadImageTask extends AsyncTask<String, Void, Bitmap> {
        ...
        private String getImagePath(String imageUrl) {
            ...
            File imageDir = EnvUtil.getDiskCacheDir(App.getContext(), "PhotoWallFalls");
            if (!imageDir.exists()) {
                imageDir.mkdirs();
            }
            return imageDir.getPath() + imageName;
        }
    }
